		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customer",
									"targetURL": "#comarvcustcustapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comarvcustcustapp-display": {
								"semanticObject": "comarvcustcustapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.arv.cust.custapp",
									"url": sap.ui.require.toUrl("com/arv/cust/custapp")
								}
							}
						}
					}
